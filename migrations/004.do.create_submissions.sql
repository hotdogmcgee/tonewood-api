CREATE TABLE submissions (
    ...
    e_long NUMERIC(5, 2) NOT NULL,
    e_cross NUMERIC(5, 2) NOT NULL,
    velocity_sound_long NUMERIC(5, 2) NOT NULL,
    radiation_ratio NUMERIC(5, 2) NOT NULL,
    sample_length NUMERIC(6, 2) NOT NULL,
    sample_width NUMERIC(5, 2) NOT NULL,
    sample_thickness NUMERIC(5, 2) NOT NULL,
